...
class Account(models.Model):
    ...
    account_id = ShortUUIDField(unique=True, length=10, max_length=25, prefix="DEX", alphabet="1234567890")
...
class KYC(models.Model):
    ...
    image = models.ImageField(upload_to="kyc", max_length=255, null=True, default=None)
